...
namespace SpaceExploration
{
    class Planet : CelObject<Planet.PlanetType>
    {
        ...
        {
            [PlanetType.Rock] = new("Rock", 25, 0, 2, 0.1, 2, 5, 2, 10, 5, 5, 40, 35, 60, 15, 5, 20, 70, 40, 25, 5, 5, 0, 0, 10, 0),
            [PlanetType.Ice] = new("Ice", 16, 1, 2, 0.2, 5, 20, 10, 15, 35, 30, 10, 10, 20, 5, 5, 5, 20, 10, 5, 1, 95, 40, 35, 20, 0),
            [PlanetType.Gas] = new("Gas Giant", 15, 0, 1, 10, 300, 95, 85, 10, 20, 5, 0, 0, 0, 5, 2, 0, 5, 2, 0, 0, 20, 60, 35, 15, 0),
            [PlanetType.Terran] = new("Terran", 12, 25, 3, 0.5, 3, 15, 5, 45, 40, 70, 20, 20, 40, 10, 5, 15, 45, 25, 20, 3, 80, 15, 10, 35, 0),
            ...
            [PlanetType.Ocean] = new("Ocean", 7, 20, 3, 0.5, 5, 20, 5, 35, 40, 75, 10, 10, 25, 5, 2, 5, 25, 10, 5, 1, 100, 20, 10, 25, 0),
